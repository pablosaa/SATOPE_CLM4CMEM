...
!    -----------------------------------------
Zb(0)=0.0      ! no veg
Zb(1)=0.23     ! PSG: 0.33 Decidious forests
Zb(2)=0.23     ! PSG: 0.33 Coniferous forests
Zb(3)=0.30     ! PSG: 0.33 Rain forests
...
Zb1(5)=0.0410    ! PSG: 0.0375 C4 Grasslands
Zb1(6)=0.10      ! PSG: 0.05 C3 Crops
Zb1(7)=0.09      ! PSG: 0.05 C4 Crops
...
Zb2(6)=0.08       ! PSG: 0.0 C3 Crops
Zb2(7)=0.08       ! PSG: 0.0 C4 Crops
...
ZNrv(2)=0.5      ! PSG: 0.0 Coniferous forests
ZNrv(3)=0.2       ! PSG: 0.0 Rain forests
...
Zw_eff(6,:)=(0.04,0.05)        ! PSG: (0.0, 0.0) C3 Crops
