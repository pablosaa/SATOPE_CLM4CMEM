...
REAL(KIND = JPRM),ALLOCATABLE :: ftheta_inc(:,:) ! PSG: pixel-based incidence angle
real(KIND = JPRM), allocatable, dimension(:,:,:,:,:) :: TB_HV ! PSG: TB with dims as [lons,lats,pol,inc,time]
